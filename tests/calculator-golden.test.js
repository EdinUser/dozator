...
describe("golden calculator scenarios", () => {
  it.each([
    ...
    },
    {
      ...
      traces: ["2 mg/mL × 20 mL = 40 mg", "40 mg ÷ 10 mg/mL = 4 mL"],
    ...
    },
    {
      ...
      primary: "12.5 mL/h",
      instructions: [
        "Концентрация в инфузията: 2 mg/mL.",
    ...
    },
    {
      ...
      primary: "4.2 mL/h",
      instructions: ["Концентрация в инфузията: 5 mg/mL.", "Настройте помпата на 4.2 mL/h."],
